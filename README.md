...
This is a poc demo. not for prod usage
The 'cmsmldbx' project was generated by using the default-python template.
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] cmsmldbx_job` to your workspace.
...
4. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/cmsmldbx.job.yml). The schedule
